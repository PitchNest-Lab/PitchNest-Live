        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-2 md:grid-cols-5 gap-8 sm:gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-slate-500 dark:text-zinc-400">
              ...
              <li><a href="mailto:prestonjaysusanto@gmail.com" className="hover:text-sky-600 dark:hover:text-sky-400 flex items-center gap-2"><Mail size={14} className="shrink-0" /> prestonjaysusanto@gmail.com</a></li>
